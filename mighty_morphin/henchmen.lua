pr_villians.register_henchman("mighty_morphin:putty", {
  description = "Putty",
...
pr_villians.register_henchman("mighty_morphin:z_putty", {
  description = "Z Putty",
...
pr_villians.register_spawner("mighty_morphin:fifteen_putty_egg", {
...
pr_villians.register_spawner("mighty_morphin:fifteen_z_putty_egg", {
